...
# Configuration
$SOURCE_DIR = "H:\WebHatchery\apps\isitdoneyet"
...
$DEST_DIR = Join-Path $DEST_ROOT "isitdoneyet"
...
function Build-Frontend {
    ...
    # Set base path for preview environment (isitdoneyet subdirectory)
    if ($Environment -eq 'preview') {
        Write-Info "Setting base path for preview environment..."
        $env:VITE_BASE_PATH = "/isitdoneyet/"
